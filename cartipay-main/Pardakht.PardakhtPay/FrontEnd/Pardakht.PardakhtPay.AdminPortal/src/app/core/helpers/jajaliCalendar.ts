...
@Injectable()
export class JajaliCalendarService {
  ...
  JajaliCalendar(gregorianDate): string {
    ...
    return this.year + "-" + this.strMonthNumber +"-" + this.day;
  ...
  toPersian(gregorianDate) {
    ...
    this.strMonthNumber = Math.floor(this.month);
