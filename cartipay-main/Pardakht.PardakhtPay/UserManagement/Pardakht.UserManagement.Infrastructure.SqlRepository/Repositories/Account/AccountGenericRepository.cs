...
{
    public class AccountGenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : class, IEntity
    {
        protected AccountRepository DbContext;

        public AccountGenericRepository(AccountRepository dbContext)
        {
            DbContext = dbContext;
        }
