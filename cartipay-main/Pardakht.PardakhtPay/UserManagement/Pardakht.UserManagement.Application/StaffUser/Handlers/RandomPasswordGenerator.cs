...
namespace Pardakht.UserManagement.Application.StaffUser.Handlers
{
    public class RandomPasswordGenerator
    {
        public string GeneratePassword()
        {
            ...
            while (!PasswordIsValid(includeLowercase: true, includeUppercase: true, includeNumeric: true, includeSpecial: false, includeSpaces: false, password: defaultPassword))
            {
                defaultPassword = GeneratePassword(includeLowercase: true, includeUppercase: true, includeNumeric: true, includeSpecial: false, includeSpaces: false, lengthOfPassword: 14);
            }

            return defaultPassword;
        }

        private string GeneratePassword(bool includeLowercase, bool includeUppercase, bool includeNumeric, bool includeSpecial, bool includeSpaces, int lengthOfPassword)
        {
        ...
        private bool PasswordIsValid(bool includeLowercase, bool includeUppercase, bool includeNumeric, bool includeSpecial, bool includeSpaces, string password)
        {
